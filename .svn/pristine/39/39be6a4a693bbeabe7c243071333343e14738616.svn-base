...
public class Build extends BuildBase {
     ...
     */
    public void docs() {
        // JT - not needed - javadoc();
        compile();
        compileTools();
        delete("docs");
        // JT - not needed - copy("docs", files("src/docsrc/index.html"), "src/docsrc");
        java("org.h2.build.doc.XMLChecker", null);
        // JT - not needed java("org.h2.build.code.CheckJavadoc", null);
        java("org.h2.build.code.CheckTextFiles", null);
        java("org.h2.build.doc.GenerateDoc", null);
        // JT java("org.h2.build.doc.GenerateHelp", null);
        // JT java("org.h2.build.i18n.PrepareTranslation", null);
        // JT java("org.h2.build.indexer.Indexer", null);
        // JT java("org.h2.build.doc.MergeDocs", null);
        java("org.h2.build.doc.WebSite", null);
        java("org.h2.build.doc.LinkChecker", null);
        java("org.h2.build.doc.XMLChecker", null);
        java("org.h2.build.doc.SpellChecker", null);
        // JT java("org.h2.build.code.CheckTextFiles", null);
        // JT - annoying beep();
    }
